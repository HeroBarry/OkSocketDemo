...
import com.vogue.socket.adapter.LogAdapter;
import com.vogue.socket.data.HandShakeBean;
import com.vogue.socket.data.LogBean;
import com.vogue.socket.data.MsgDataBean;
...
public class SimpleDemoActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        Toast.makeText(SimpleDemoActivity.this,mIPET.getText().toString()+":"+mPortET.getText().toString(),Toast.LENGTH_LONG).show();
        initManager();
    }
    ...
    private void initManager() {
        ...
        if (mManager.isConnect()){
            Toast.makeText(SimpleDemoActivity.this,"isConnect",Toast.LENGTH_LONG).show();
        }
